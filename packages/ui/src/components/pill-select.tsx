    ...
    <Menu.Root modal={false}>
      <Menu.Trigger
        ...
        className={cn(
          ...
          "border-border bg-card/35 shadow-md shadow-black/20 backdrop-blur-xl inline-flex h-7 cursor-pointer items-center gap-1 rounded-pill border px-2 py-1 text-xs font-normal text-foreground outline-none",
