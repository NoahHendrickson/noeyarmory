...
const nextConfig: NextConfig = {
  ...
  async headers() {
    const csp = [
      ...
      "img-src 'self' data: https://www.bungie.net https://data.shaders.com",
      "font-src 'self'",
      "connect-src 'self' https://www.bungie.net https://data.shaders.com https://database-clarity.github.io https://*.clarity.ms https://c.bing.com",
