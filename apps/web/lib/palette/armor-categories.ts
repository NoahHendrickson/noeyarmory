...
import { collectRaidSourceFacets } from "@repo/destiny";

import type { OwnedArmorItem } from "../armor-types";
import { collectOwnedArmorFacets } from "../owned-armor-search";
import { facetCategory, raidSourceCategory } from "./weapon-categories";
...
export function buildArmorCategories(owned: OwnedArmorItem[]): PaletteCategory[] {
  ...
  return [
    ...
    raidSourceCategory(collectRaidSourceFacets(owned, { includeAllRaidLabels: true })),
